...
export function AIChat() {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    { role: "assistant", content: "Olá! 👋 Sou a assistente da NETFILMES. Como posso ajudar? Pergunte sobre planos VIP, depósitos, saques ou ganhos." },
  ]);
          ...
          >
            <div className="flex items-center justify-between bg-gradient-to-br from-primary to-purple-700 p-4 text-white">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-sm font-bold">Assistente NETFILMES</div>
