...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-40 border-b bg-card">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
          ...
          <Link to="/home" className="text-xl font-black tracking-wider">
            NET<span className="text-primary">FILMES</span>
          </Link>
      ...
      <a
        href={whatsappUrl(lang === "pt" ? "Olá! Preciso de ajuda na NETFILMES." : "Hi! I need help on NETFILMES.")}
          ...
          <aside className="relative flex h-full w-[88%] max-w-sm flex-col bg-sidebar text-sidebar-foreground">
            <div className="bg-gradient-header p-4 text-primary-foreground">
              <div className="flex items-center justify-between">
                <span className="text-lg font-black tracking-wider">NETFILMES S.A</span>
            ...
            <div className="border-t border-sidebar-border p-3">
              ...
              <div className="mt-3 text-center text-xs text-sidebar-foreground/40">NETFILMES © 2026</div>
            </div>
          </aside>
        </div>
      )}
