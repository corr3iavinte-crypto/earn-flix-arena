...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NETFILMES — Assista vídeos e ganhe" },
      ...
      { name: "apple-mobile-web-app-title", content: "NETFILMES" },
      { name: "mobile-web-app-capable", content: "yes" },
      { property: "og:title", content: "NETFILMES — Assista vídeos e ganhe" },
      { name: "twitter:title", content: "NETFILMES — Assista vídeos e ganhe" },
