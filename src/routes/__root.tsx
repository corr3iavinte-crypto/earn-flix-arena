...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Petromoc S.A — Assista vídeos e ganhe" },
      ...
      { name: "apple-mobile-web-app-title", content: "Petromoc S.A" },
      { name: "mobile-web-app-capable", content: "yes" },
      { property: "og:title", content: "Petromoc S.A — Assista vídeos e ganhe" },
      { name: "twitter:title", content: "Petromoc S.A — Assista vídeos e ganhe" },
