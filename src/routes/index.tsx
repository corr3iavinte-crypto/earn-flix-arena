  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="bg-gradient-header text-primary-foreground">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold">NETFILMES</span>
          </div>
        ...
        <div className="mx-auto max-w-3xl px-4 pb-16 pt-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm opacity-90 md:text-base">Plataforma NETFILMES em Moçambique. Planos VIP a partir de 650 MZN. Retornos diários de 10% a 14%.</p>
      ...
      <footer className="border-t bg-card py-6 text-center text-xs text-muted-foreground">
        © 2026 NETFILMES · Operado em Moçambique
      </footer>
    </div>
  );
}
